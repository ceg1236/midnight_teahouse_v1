...
- [ ] **Guestlist tab (optional)** – If using door ops tab, set `GUESTLIST_SHEET_NAME` and create headers: Timestamp, Name, Email, Ticket date, Ticket type, Quantity, Amount paid, Stripe Payment ID, Checked in, Checked-in at, Door notes, Refunded, Refund notes.
