...
const EVENTS: Record<string, EventConfig> = {
  ...
  'turby-event': {
    ...
    timeLabel: '11am-3pm',
    locationLabel: 'Outdoor café · San Francisco',
    ...
    hostSectionTitle: 'About our host',
    hostSectionDescription:
      'Turby opens their garden for this daytime pop-up—an outdoor café for tea, music, and easy conversation in the sun.',
