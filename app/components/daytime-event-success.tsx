...
function DaytimeEventSuccessContent({ eventSlug }: { eventSlug: string }) {
  ...
  const successNotes = getDaytimeSuccessPageNotes(eventSlug, ticketFormat)
...
export function DaytimeEventSuccess({ eventSlug }: { eventSlug: string }) {
  return (
    <Suspense fallback={
      ...
      <DaytimeEventSuccessContent eventSlug={eventSlug} />
    </Suspense>
  )
}
