...
export const eventTiers = [
  { id: 'supported', label: 'Supported', mainLine: 'Supported $20+', blurb: 'This is our reduced price ticket for those who would like to be supported by the community.', price: 20 },
