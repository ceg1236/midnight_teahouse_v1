...
export const specialEventDates = [
  {
    ...
    value: '2026-04-21',
    capacity: 45,
    musicians: ['In the spirit of this new home, our musicians will roam throughout the evening—offering intimate, acoustic sets that unfold alongside the flow of tea and the rhythm of the room.'],
  },
  {
    id: 'apr-22',
    day: 'Wednesday',
